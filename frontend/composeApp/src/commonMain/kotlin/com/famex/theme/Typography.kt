...
fun famExTypography(fontFamily: FontFamily): FamExTypography = FamExTypography(
...
// composables (which pull from MaterialTheme.typography rather than FamExTypography) stay
